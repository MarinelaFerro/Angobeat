...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-end mb-4 ">
            <button type="button" class="btn btn-secondary btn-sm" onclick="window.location.href ='tableplaylist.html'" >Listar playlist</button>
          </div>
          ...
          <div class="shadow-lg p-3 mb-5 bg-white rounded content-wrapper">
              <div class="box add-playlist">
                  ...
                  <div class="add">
                      <a href=""data-toggle="modal" data-target="#cadastroPlaylist"><ion-icon name="add-outline"></ion-icon></a>
              ...
              <div class="box">
               ...
               <img src="/img/imagens/bts.jpg" alt="">  
              </div>
              ...
              <div class="box">
                <div class="btn-play"> 
                  ...
                  <img src="/img/imagens/6(2).jpg" alt=""> 
               </div>
              ...
              <div class="box">
                <div class="btn-play"> 
                  ...
                  <img src="/img/imagens/bts_smaller.jpg" alt="">
               </div>
  ...
  <div class="modal fade bd-example-modal-xl" id="cadastroPlaylist" tabindex="-1"> 
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
           <h5 class="modal-title">Criar playlist</h5>
           <button type="button" class="close" data-dismiss="modal"></button>
           <span>&times;</span>
        </div>
        <div class="modal-body">
         <div class="img-area-modal">
             <div class="camara">
         ...
         <form>
            <div class="form-group">
              <label for="nome">Crie um nome</label>
              <input type="nome" class="form-control" id="nomeplaylist" placeholder="Nome da playlist">
            </div>
            <div class="form-group">
                <label for="desc">Descrição</label>
                <input type="desc" class="form-control" id="nomeplaylist" placeholder="Descreve um pouco sobre a tua playlist">
              </div>
           
            <div class="form-group form-check">
              <input type="checkbox" class="form-check-input" id="exampleCheck1">
              <label class="form-check-label" for="exampleCheck1">Privada</label>
             </div>
             <div class="form-group form-check">
                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                <label class="form-check-label" for="exampleCheck1">Pública</label>
               </div>

        <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal">Criar</button>
