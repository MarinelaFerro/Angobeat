      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">100 artistas</h1>
          ...
          <div class="shadow-lg p-3 mb-5 bg-white rounded content-wrapper">
            <div class="box">
              <div class="btn-overlay">
                <div class="play">
                   <a href="#"><ion-icon name="caret-forward-outline"class="icon-area"></ion-icon></a>
                </div>
              ...
              <div class="img-box">
                <img src="/img/imagens/amigas.jpg" class="img-area">
              </div>
              <div class="info-box">
                <h6><a href="userpag.html">Marinela ferro</a></h6>
           ...
           <div class="box">
            <div class="btn-overlay">
              <div class="play">
                 <a href="userpag.html"><ion-icon name="caret-forward-outline"class="icon-area"></ion-icon></a>
              </div>
