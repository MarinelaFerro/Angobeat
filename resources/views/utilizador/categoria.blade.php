...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-end mb-4 ">
            <button type="button" class="btn btn-primary btn-sm" style="margin: 5px;" data-toggle="modal" data-target="#cadastroCategoria">Adicionar categoria</button>
            <button type="button" class="btn btn-secondary btn-sm" onclick="window.location.href ='tablecategoria.html'" >Listar categorias</button>
          </div>
  ...
  <div class="modal fade bd-example-modal-xl" id="cadastroCategoria" tabindex="-1"> 
        ...
        <div class="modal-body">
         <form>
            <div class="form-group">
              ...
              <input type="nome" class="form-control" id="nomecat" placeholder="Nome da categoria">
            </div>
            </form>
        <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="location.href='categoria.html'">Criar</button>
