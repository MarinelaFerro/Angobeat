...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-end mb-4 ">
            <button type="button" class="btn btn-primary btn-sm" style="margin: 5px;" onclick="window.location.href='formaddmusic.html'">Adicionar musica</button>
            <button type="button" class="btn btn-secondary btn-sm" onclick="window.location.href ='tablemusic.html'" >Listar musicas</button>
          </div>
          ...
          <div class=" shadow-lg p-3 mb-5 bg-white rounded  container-wrapper">
            <div class="box-music">
              <img src="/img/imagens/18299868_166312460566261_1350209117951623168_n.jpg" alt="">
              <div class="btn-overlay">
                   <div class="icon">
                     <a href=""><ion-icon name="heart-outline"></ion-icon></a>
                     </div>
                   <div class="icon">
                     <a href="http://"><ion-icon name="add-outline"></ion-icon></a>
                   </div>
                 </div>
                 <div class="info">
            ...
            <div class="box-music">
              <img src="/img/imagens/gif/6304c459da3c892c7390bfaa1d27a1855e0587a9_hq.gif" alt="">
              <div class="btn-overlay">
                   <div class="icon">
                     <a href=""><ion-icon name="heart-outline"></ion-icon></a>
                     </div>
            ...
            <div class="box-music">
              <img src="/img/imagens/happines.jpg" alt="">
              <div class="btn-overlay">
                   <div class="icon">
                     <a href=""><ion-icon name="heart-outline"></ion-icon></a>
                     </div>
  ...
  <div class="modal fade" id="modalcadastro" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
           <h5 class="modal-title">Cadastro de album</h5>
        ...
        <div class="modal-body">
          ...
          <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="titulo" aria-describedby="tituloAlbum" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="datapub">Data_pub</label>
                <input type="date" class="form-control" id="datapub">
              </div>
